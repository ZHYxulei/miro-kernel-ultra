...
| `AK3_DEVICE_NAME1` | `24122RKC7C` | `device.name1=` | 设备名称 1（型号） |
| `AK3_DEVICE_NAME2` | `miro` | `device.name2=` | 设备名称 2（内核代号） |
| `AK3_DEVICE_NAME3` | `Redmi K80 Pro` | `device.name3=` | 设备名称 3（设备名） |
...
```bash
# 开启设备检测并设置设备名称
AK3_DEVICE_CHECK=1 AK3_DEVICE_NAME1=24122RKC7C AK3_DEVICE_NAME2=miro ./build.sh zip
